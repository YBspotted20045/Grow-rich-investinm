  ...
  useEffect(() => {  
    (async () => {  
      try {  
        ...
        if (!res.data || !res.data._id) throw new Error("No user found in response");  
        ...
        if (res.data.investmentDate && res.data.maturityDate) {  
    ...
    <div className="page-shell">  
      ...
      <main className="main">  
        <div className="topbar">  
          <h3>Dashboard</h3>  
          <div className="muted">Welcome, {user.username}</div> {/* ✅ fixed */}  
        </div>  
